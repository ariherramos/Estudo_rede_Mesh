...
#define MEUIP 0x00000001
#define MINHAPORTA 10100
...
void loop()
{
  ...
  {
    Radio.stopListening();
    send_("Hello Word",11,MEUIP,0x00000002,MINHAPORTA,10050);//void send_ (byte *payload,byte lenght,int srcIP,int dstIP,short srcPort,short dstPort){
